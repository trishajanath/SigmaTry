  ...
  return (
    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          <Text style={styles.main}>Lift</Text>
        ...
        >
          ...
          <SelectList
            ...
            data={["Cleaning", "Lights and Switches", "Fan", "Not Working"]}
            save="value"
          />
          <View style={styles.stepContainer}>
...
const styles = StyleSheet.create({
  main: {
    fontSize: 20,
    marginTop: Platform.OS === 'ios' ? "-70%" : "-13%",
    
    textAlign: "center",
    marginBottom: "5%",
  },
  nextBtn: {
    marginTop: Platform.OS === 'ios' ? "-220%" : "-100%",
   
  },
  previousBtn: {
    marginTop: Platform.OS === 'ios' ? "-192%" : "-100%",
