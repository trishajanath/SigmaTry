  ...
  const handleSubmit = async () => {
    ...
    try {
      const Submit = {
        ...
        id: state.employeeId,
        issueType: "Complaint",
        issueCat: "ECE Department",
        actionItem: "ECE Department",
    ...
    <PaperProvider>
      <ScrollView style={styles.container}>
        <Card style={styles.card}>
          <Card.Content>
            <Text style={styles.title}>ECE Department Incident Report</Text>
            ...
            <TextInput
              ...
              style={styles.input}
              placeholder="e.g., Signal Generator, Spectrum Analyzer, Network Analyzer"
            />
...
export default ECEIncidentForm; 