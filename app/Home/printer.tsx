...
function reducer(state: any, action: any) {
  switch (action.type) {
    ...
    case "SET_PRINTER_ID":
      return { ...state, printerId: action.payload };
    case "SET_CONTENT":
    ...
    <>
      ...
      >
        <View style={styles.container}>
          <Text style={styles.main}>Printer Complaint</Text>
          ...
          <Text style={styles.label}>Printer ID</Text>
          <TextInput
            style={styles.input}
            placeholder="Printer ID"
            value={state.printerId}
            onChangeText={(text) =>
              dispatch({ type: "SET_PRINTER_ID", payload: text })
            }
          />
