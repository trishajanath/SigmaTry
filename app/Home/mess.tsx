    ...
    <>
      ...
      >
        <View style={styles.container}>
          <Text style={styles.main}>Mess Complaint</Text>
          ...
          {state.selectedOptionType === "Feedback" && (
            <>
              <Text style={styles.label}>Food Quality Rating</Text>
              <View style={styles.ratingContainer}>
                {[1, 2, 3, 4, 5].map((rating) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.ratingButton,
                      state.ratingFood === rating && styles.selectedRating,
                    ]}
                    onPress={() => handleRatingSelect("ratingFood", rating)}
                  >
                    <Text
                      style={[
                        styles.ratingText,
                        state.ratingFood === rating && styles.selectedRatingText,
                      ]}
                    >
                      {rating}
                    </Text>
