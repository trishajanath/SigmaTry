  ...
  const handleSubmit = async () => {
    ...
    try {
      const Submit = {
        ...
        id: state.employeeId,
        issueType: "Complaint",
        issueCat: "EEE Department",
        actionItem: "EEE Department",
    ...
    <PaperProvider>
      <ScrollView style={styles.container}>
        <Card style={styles.card}>
          <Card.Content>
            <Text style={styles.title}>EEE Department Incident Report</Text>
            ...
            <TextInput
              ...
              style={styles.input}
              placeholder="e.g., Oscilloscope, Power Supply, Multimeter"
            />
...
export default EEEIncidentForm; 