  ...
  const handleSubmit = async () => {
    if (
      ...
      (state.selectedOptionType === "Feedback" &&
        (state.ratingSeverity === undefined ||
    ...
    try {
      const Submit = {
        ...
        "survey-severity": state.ratingSeverity,
    ...
    <>
      ...
      >
        <View style={styles.container}>
          <Text style={styles.main}>Other Issues</Text>
          ...
          {state.selectedOptionType === "Feedback" && (
            <>
              <Text style={styles.label}>Severity Rating</Text>
              <View style={styles.ratingContainer}>
                {[1, 2, 3, 4, 5].map((rating) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.ratingButton,
                      state.ratingSeverity === rating && styles.selectedRating,
                    ]}
                    onPress={() => handleRatingSelect("ratingSeverity", rating)}
                  >
                    <Text
                      style={[
                        styles.ratingText,
                        state.ratingSeverity === rating && styles.selectedRatingText,
                      ]}
                    >
                      {rating}
                    </Text>
...
export default OtherIssuesForm; 